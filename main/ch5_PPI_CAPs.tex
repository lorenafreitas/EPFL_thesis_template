...
\add{Add little intro here about task-based dynamics}
...
\begin{center}
 \textit{(Preprint of article to submit to... )}\add{Check author list and where to submit}
...
\add{add paragraph to Supplementary Material about running 100 replicates for the final chosen K }
